...
public class DialogRequest {
    ...
    }, tuple -> tuple.getB().getCharacterState().getRelationWith(tuple.getA().getUniqueID()) > CharacterState.MAX_RELATIONSHIP / 2 && !tuple.getB().getFollowedPlayerUUID().isPresent());
    public static final  DialogRequest              DISBAND       = DialogRequest.create("disband", tuple -> tuple.getB().setFollowedPlayer(null), tuple -> tuple.getB().getFollowedPlayerUUID().isPresent());
