...
public class ModContainerTypes {
    ...
    public static final ContainerType<OutsiderInventoryContainer> OUTSIDER_INVENTORY=IForgeContainerType.create(OutsiderInventoryContainer::new);
    public static final ContainerType<?>[] CONTAINER_TYPES=new ContainerType[]{
            ...
            OUTSIDER_INVENTORY.setRegistryName("outsider_inventory")
    };
}
